...
type ChartScale struct {
	...
	DomainNumStart float32 `protobuf:"fixed32,4,opt,name=domain_num_start,json=domainNumStart,proto3" json:"domain_num_start,omitempty"`
	// End of the numeric scale domain.
	DomainNumEnd float32 `protobuf:"fixed32,5,opt,name=domain_num_end,json=domainNumEnd,proto3" json:"domain_num_end,omitempty"`
	// Scale string categories.
	DomainCategories []string `protobuf:"bytes,6,rep,name=domain_categories,json=domainCategories,proto3" json:"domain_categories,omitempty"`
	...
	InnerPadding float32 `protobuf:"fixed32,8,opt,name=inner_padding,json=innerPadding,proto3" json:"inner_padding,omitempty"`
	// Outer padding for categories.
	OuterPadding float32 `protobuf:"fixed32,9,opt,name=outer_padding,json=outerPadding,proto3" json:"outer_padding,omitempty"`
}
...
func (x *ChartScale) GetRangeStart() int32 {
	if x != nil {
		return x.RangeStart
	}
	return 0
...
func (x *ChartScale) GetRangeEnd() int32 {
	if x != nil {
		return x.RangeEnd
	}
	return 0
...
func (x *ChartScale) GetDomainNumStart() float32 {
	if x != nil {
		return x.DomainNumStart
	}
	return 0
}

func (x *ChartScale) GetDomainNumEnd() float32 {
	if x != nil {
		return x.DomainNumEnd
	}
	return 0
}

func (x *ChartScale) GetDomainCategories() []string {
	if x != nil {
...
func (x *ChartScale) GetInnerPadding() float32 {
	if x != nil {
...
func (x *ChartScale) GetOuterPadding() float32 {
	if x != nil {
...
var file_scale_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x22, 0xb9, 0x03, 0x0a, 0x0a, 0x43, 0x68, 0x61, 0x72, 0x74, 0x53,
	...
	,
